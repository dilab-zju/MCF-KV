...
static constexpr int StopWritesTrigger = 30;

static constexpr int CompactCandidateStopWriteTrigger = 4;

// min file number to start compaction check round
static constexpr int StartCompactionCheckTrigger = 25;

// Number of files in merge candidate to be checked in on round
static constexpr int FilesToPickAtOneRound = 50;

static constexpr int MaxRoundNumberForPerFile = 24;

static constexpr int MaxPickTimes = 250;

// Number of round to check
static constexpr int MaxMergeCandidateCheckRound = 3;

// Approximate gap in bytes between samples of data read during iteration.
static constexpr int kReadBytesPeriod = 1048576;

static constexpr int MaximumFileNum = 512;

static constexpr double EvictRatio = 0.75;

static constexpr double PickRatio = 0.7;
